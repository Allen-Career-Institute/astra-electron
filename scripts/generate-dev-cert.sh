...
main() {
    ...
    echo ""
    echo "  bun run dev:build        - Build with local certificates"
    echo "  bun run dev:package      - Package with local certificates"
    echo "  bun run dev:make         - Create installers with local certificates"
    echo ""
